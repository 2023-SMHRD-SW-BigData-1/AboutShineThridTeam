...
<body>
  <section class="notice Sh-notice">
    ...
    <ul class="w-100 d-flex justify-content-between mt-3 Sh-comm-head">
      ...
      <li class="d-flex mx-5">
        <div><input type="submit" value="수정" class="Sh-comm-ctt-comment-input"></div>
        <div><input type="submit" value="삭제" class="Sh-comm-ctt-comment-input"></div>
        <div><input type="submit" value="돌아가기" class="Sh-comm-ctt-comment-input"></div>
      </li>
    </ul>
    <div id="board-list">
      <div class="containe">
        <ul class="w-100 p-2 d-flex justify-content-between Sh-comm-head">
          ...
          <li class="d-flex justify-content-between mx-5 Sh-comm-head-ctt2">
            <div class="d-flex justify-content-end align-items-center Sh-comm-head-ctt2-a1 chat-thumb">
              <i class="mx-2 fa-solid fa-comments Sh-fa-imot"></i>
              <h4>채팅</h4>
            </div>
            <div class="d-flex justify-content-end align-items-center Sh-comm-head-ctt2-a2 email-thumb"
              data-bs-toggle="modal" data-bs-target="#emailComposeSidebar" id="emailComposeSidebarLabel">
              <i class="mx-2 fa-solid fa-envelope Sh-fa-imot"></i>
              <h4>이메일</h4>
            </div>
            <a href="#" class="d-flex justify-content-end align-items-center Sh-comm-head-ctt2-a3">
          ...
          <table class="w-100 Sh-comm-ctt-box">
            <tbody class="Sh-comm-ctt-body">
              <tr>
                <th class="p-3">
                  <p>내용입니덩
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis explicabo rerum
        ...
        <ul class="w-100 d-flex justify-content-between mt-3 Sh-comm-head">
          <li class="d-flex mx-5">
            <div><input type="submit" value="댓글달기" class="Sh-comm-ctt-comment-input"></div>
          </li>
        </ul>
        <!-------------------- comment-wright-btn ------------------>
        ...
        <ul class="w-100 d-flex justify-content-between mt-3 Sh-comm-head">
          ...
          <li class="d-flex mx-5">
            <div><input type="submit" value="등록" class="Sh-comm-ctt-comment-input"></div>
            <div><input type="submit" value="취소" class="Sh-comm-ctt-comment-input"></div>
          </li>
        </ul>
        <div class="w-100 p-2 Sh-comm-body">
          <table class="Sh-comment-ctt-box">
            <tbody class="Sh-comm-ctt-body">
              <tr>
                <th class="p-3">
                  <input type="textarea" class="w-100 p-1">
                </th>
              </tr>
            </tbody>
          </table>
        ...
        <div class="w-100 p-2 Sh-comm-body">
          <table class="Sh-comment-ctt-box">
            <tbody class="Sh-comm-ctt-body">
              <tr>
                <th class="p-3">
                  <p>댓글란입니덩Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis explicabo
                    rerum
                    voluptatem. Nihil ut minus, suscipit iste voluptates earum saepe eos neque sed,
                    fuga beatae numquam nobis consectetur ipsum cupiditate!
                    Non voluptas eveniet numquam libero! Eligendi necessitatibus esse accusamus ipsa
    ...
    <div class="row mx-0 mt-3">
      <div class="col-sm-12 col-md-6 w-75">
        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
          <ul class="pagination Sh-ctt-pagination">
            ...
            <li class="paginate_button page-item active"><a href="#" aria-controls="DataTables_Table_0" aria-role="link"
      ...
      <div class="w-25">
        <div class="d-flex justify-content-end">
          <button style="height: 30px; border-radius: 4px; background-color: #7367F0; border: none; color: #fff;"
  ...
  <div id="modal-chat" class="w-100 h-100 top-0 left-0 justify-content-center align-items-center">
      ...
      <div class="col app-chat-history bg-body">
        <div class="chat-history-wrapper">
          ...
          <div class="chat-history-body bg-body ps ps--active-y">
            ...
            <div class="ps__rail-y" style="top: 97px; height: 997px; right: 0px;">
              <div class="ps__thumb-y" tabindex="0" style="top: 89px; height: 907px;"></div>
            </div>
          </div>
          <!-- Chat message form -->
  ...
  <!-------------------- modal - chat ------------------>
  <!-------------------- modal - email ------------------>
  <div id="modal-email" class="w-100 h-100 top-0 left-0 justify-content-center align-items-center">
        ...
        <div class="modal-body flex-grow-1 pb-sm-0 p-4 py-2">
          <form class="email-compose-form">
            <div class="email-compose-to d-flex align-items-center">
              ...
              <input type="text" class="mx-3 w-75 border-0 border-bottom">
            </div>
                  ...
                  <span class="d-flex ql-formats me-0">
                    ...
                    <div class="d-flex align-items-center w-100">
                      <div class="dropdown mxl-auto">
                        <button class="btn p-0" type="button" id="dropdownMoreActions" data-bs-toggle="dropdown"
            ...
            <div class="email-compose-actions d-flex justify-content-end align-items-center mt-3 mb-3">
              <div class="d-flex justify-content-end btn-group">
                <button type="reset" class="btn" data-bs-dismiss="modal" aria-label="Close">
                  <i class="ti ti-trash"></i>
                </button>
                <button type="reset" class="btn btn-primary waves-effect waves-light" data-bs-dismiss="modal"
                  aria-label="Close">
