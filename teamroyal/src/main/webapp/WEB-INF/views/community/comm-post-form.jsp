<%@page import="com.community.controller.CommuController" %>
	...
	<div
		...
		<div class="layout-container">
			<div class="w-100 mt-5">
				<h3 class="text-align-center" style="text-align: center;">게시글을
					작성해주세요.</h3>
			</div>
			<!-- Layout container -->
												...
												<div class="row g-3">
													<form action="/community/list/post/write" method="post">
														<div class="col-md-12">
															...
															<input name="commuTitle" type="text"
																id="collapsible-fullname" class="form-control"
																placeholder="제목을 입력해주세요" />
														</div>
														<div class="col-12">
															<label class="form-label" for="collapsible-address">내용</label>
															<textarea name="commuText" class="form-control"
																id="collapsible-address" rows="20"
