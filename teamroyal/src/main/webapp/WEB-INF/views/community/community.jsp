            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card w-100">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>안녕하세요 태양광 정보가 너무 궁금합니다</td>
                            <td>박충희</td>
                            <td>
                                <a href="../community/chat.html"><i class="ti ti-message"></i></a>
                            </td>
                            <td>
                                <a href="../mypage/pages-profile-email.html"><i class="ti ti-mail"></i></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../mypage/pages-profile-email.html"><i class="ti ti-mail"></i></i></a>
                            </td>
                ...
                <a href="community-form.html" class="btn btn-primary waves-effect waves-light sh-comm-wright">글쓰기</a>
            </div>
        </div>
    </div>
            <!--/ Content -->
