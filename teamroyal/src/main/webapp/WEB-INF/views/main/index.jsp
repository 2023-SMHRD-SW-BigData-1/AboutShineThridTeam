...
<body>
					...
					<div class="collapse navbar-collapse" id="navbar-ex-5">
						<div class="navbar-nav me-auto">
							...
							<a class="nav-item nav-link"
								href="/html/community/community.html">COMMUNITY</a> <a
								class="nav-item nav-link" href="/html/community/chat.html">CHAT</a>
							<a class="nav-item nav-link"
								href="/html/community/community-mail.html">MAIL</a> <a
								class="nav-item nav-link" href="/html/power/power-plant.html">POWER
								PLANT</a>
						</div>
						<ul class="navbar-nav ms-lg-auto">
							<li class="nav-item"><a class="nav-link"
								href="/html/mypage/pages-profile-userprofile.html"><i
  ...
  <!-- shine chart js-->
  <script src="../ex/sh-highchart.js"></script>
